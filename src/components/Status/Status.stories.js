...
export default { title: "Components|Status", component: Status };
...
export const typical = () => {
  return (
    <Grid>
      ...
      />
      <Status isBlock={false} statusType="warning" message="Failsafe Warning" />
      <Status isBlock={false} statusType="info" message="Scuttle Procedure" />
      <Status
        isBlock={false}
        statusType="success"
      ...
      <Status
        ...
        message="Emergency Destruction System"
      />
      <Status isBlock={true} statusType="warning" message="Failsafe Warning" />
      <Status isBlock={true} statusType="info" message="Scuttle Procedure" />
      <Status
        isBlock={true}
        statusType="success"
        message="Self-Destruct Canceled!"
