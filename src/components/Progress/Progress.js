...
const Progress = styled.div.attrs((props) => ({
  ...
  --indeterminate-pie-circle-animation-timing-function: cubic-bezier(
    0.53,
    0.21,
    0.29,
    0.67
  ); // Default follows Microsoft's FluentUI style: https://developer.microsoft.com/en-us/fluentui#/controls/web/spinner
  ...
  ${(props) =>
    ...
    css`
      ...
      &:after {
        ...
        transition: width var(--change-smoothing-duration)
          var(--change-smoothing-timing-function);
      }
        ...
        css`
          ...
          &:after {
            ...
            animation: ${indeterminateBar}
              var(--indeterminate-bar-animation-duration)
              var(--indeterminate-bar-animation-timing-function) infinite;
  ...
  ${(props) =>
    ...
    css`
      ...
      ${(props) =>
        ...
        css`
          ...
          animation: ${indeterminatePie}
            var(--indeterminate-pie-circle-animation-duration)
            var(--indeterminate-pie-circle-animation-timing-function) infinite
      ...
      =  (Math.sqrt(2) / 2) - (1 / 2) */
        ...
        --mask: radial-gradient(
          ...
          transparent 0%,
          transparent
            calc(100% - var(--magic-offset) - var(--circle-width) - 1px),
    ...
    @supports (background-image: ${CONIC_SUPPORT_REQUIREMENTS}) {
        transition: background var(--change-smoothing-duration)
          var(--change-smoothing-timing-function);
    ...
    climbing that mountain. */
      @supports not (background-image: ${CONIC_SUPPORT_REQUIREMENTS}) {
        &:after {
          ...
          transform-origin: center center;
          background: var(--fill-color, currentColor);
          transition: clip-path var(--change-smoothing-duration)
            var(--change-smoothing-timing-function);
          ...
          --main-angle: calc(
            var(--part) -
              (90 * (var(--gt-25, 0) + var(--gt-50, 0) + var(--gt-75, 0)))
          );
          ...
          --sin-term-β-3: calc(
            (var(--β) * var(--β) * var(--β) * var(--β) * var(--β)) / 120
          );
          --sin-term-β-4: calc(
            (
                var(--β) * var(--β) * var(--β) * var(--β) * var(--β) * var(--β) *
                  var(--β)
              ) / 5040
          );
          --sin-term-β-5: calc(
          ...
          --sin-β: calc(
            var(--sin-term-β-1) - var(--sin-term-β-2) + var(--sin-term-β-3) -
              var(--sin-term-β-4) + var(--sin-term-β-5)
          );
          --sin-term-α-1: var(--α);
          ...
          --sin-α: calc(
            var(--sin-term-α-1) - var(--sin-term-α-2) + var(--sin-term-α-3) -
              var(--sin-term-α-4) + var(--sin-term-α-5)
          );
          ...
          --polygon: polygon(
            ...
            100% 0%,
            calc(
                50% + (var(--pos-B) * 1% * var(--lt-25, 1)) +
                  (var(--gt-25, 0) * 50%)
              )
              calc(50% - (var(--pos-A) * 1% * var(--lt-25, 1))),
            calc(50% + (var(--gt-25, 0) * 50%))
              calc(50% + (var(--gt-25, 0) * 50%)),
            calc(
                50% + (var(--pos-A) * 1% * var(--lt-50, 1)) +
                  (var(--gt-50, 0) * 50%)
              )
              calc(
                50% + (var(--pos-B) * 1% * var(--lt-50, 1)) +
                  (var(--gt-50, 0) * 50%)
              ),
            calc(50% - (var(--gt-50, 0) * 50%))
              calc(50% + (var(--gt-50, 0) * 50%)),
            calc(
                50% - (var(--pos-B) * 1% * var(--lt-75, 1)) -
                  (var(--gt-75, 0) * 50%)
              )
              calc(50% + (var(--pos-A) * 1% * var(--lt-75, 1))),
            calc(50% - (var(--gt-75, 0) * 50%))
              calc(50% - (var(--gt-75, 0) * 50%)),
            calc(50% - (var(--pos-A) * 1% * var(--gt-75, 0)))
              calc(50% - (var(--pos-B) * 1% * var(--gt-75, 0))),
            50% 50%
          );
