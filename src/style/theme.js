...
export const keenDark = {
  ...
  COLOR_CONTENT_DEFAULT: "hsla(0, 0%, 100%, 80%)",
  COLOR_CONTENT_CONTRAST: "hsl(0, 0%, 100%)",
  COLOR_CONTENT_MUTED: "hsla(0, 0%, 100%, 60%)",
  COLOR_CONTENT_NONESSENTIAL: "hsla(0, 0%, 100%, 50%)",

  COLOR_INTENT_HIGHLIGHT: lighten(
    LIGHTENING_FACTOR,
    keen.COLOR_INTENT_HIGHLIGHT
  ),
  COLOR_INTENT_SUCCESS: lighten(LIGHTENING_FACTOR, keen.COLOR_INTENT_SUCCESS),
  ...
  COLOR_KEYLINE_DEFAULT: "hsla(0, 0%, 100%, 16%)",
